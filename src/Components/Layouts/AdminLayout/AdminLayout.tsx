...
import { MdOutlineDashboard, MdOutlineEditCalendar } from "react-icons/md";
      ...
      <div className="flex">
        ...
        >
          <div className="flex h-[60px] items-center">
            {collapsed ? null : <div className="text-center w-full">
          ...
          <Menu.Item
            ...
            key={"logout"}
            icon={<AiOutlineLogout size={20} className="text-[#FFFFFF]" />}
            onClick={() => {
              handleSignout();
            }}
          >
